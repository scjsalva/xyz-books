...
AuthorBook.find_or_create_by!(author: authors[0], book: books[2]) # Joel Hartse - American Elf
AuthorBook.find_or_create_by!(author: authors[1], book: books[2]) # Hannah Templer - American Elf
AuthorBook.find_or_create_by!(author: authors[2], book: books[2]) # Marguerite Duras - American Elf

AuthorBook.find_or_create_by!(author: authors[3], book: books[3]) # Kingsley Amis - Cosmoknights
AuthorBook.find_or_create_by!(author: authors[3], book: books[4]) # Kingsley Amis - Essex County

AuthorBook.find_or_create_by!(author: authors[1], book: books[5]) # Hannah Templer - Hey, Mister (Vol 1)
AuthorBook.find_or_create_by!(author: authors[4], book: books[5]) # Fannie Flagg - Hey, Mister (Vol 1)
AuthorBook.find_or_create_by!(author: authors[5], book: books[5]) # Camille Paglia - Hey, Mister (Vol 1)

AuthorBook.find_or_create_by!(author: authors[6], book: books[6]) # Rainer Rilke - The Underwater Welder